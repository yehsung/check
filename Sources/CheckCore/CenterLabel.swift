...
package enum CenterLabel {
    ...
    package static func serverValue(forDisplay display: String?) -> String? {
        switch display {
    ...
    package static func isKnown(_ serverValue: String?) -> Bool {
