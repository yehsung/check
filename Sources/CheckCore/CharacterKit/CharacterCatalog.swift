...
package struct CharacterCatalog: Sendable {
    ...
    package static func load(charactersDirectory: URL?, fileManager: FileManager = .default) -> CharacterCatalog {
    ...
    package static func directoryURL(
        in bundle: Bundle,
