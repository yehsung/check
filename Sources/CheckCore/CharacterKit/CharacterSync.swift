...
package enum CharacterSyncDecision: Equatable {
    ...
    package static let migrationDefaultsKey = "check.character.serverAuthorityMigrated"
    ...
    package static func migrationSettled(byStatus status: String?) -> Bool {
        switch status {
    ...
    package static func normalized(_ id: String?) -> String? {
...
package enum CharacterSyncReason: Equatable {
    /// 저장 세션 활성화(실행당 1회).
    case launch
