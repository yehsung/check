...
package struct SpriteAlphaMask: Sendable, CustomStringConvertible {
    ...
    package var description: String { "SpriteAlphaMask(\(width)x\(height))" }
    ...
    package init?(atlas: CGImage, states: [String: CharacterManifest.State], threshold: UInt8 = 32) {
    ...
    package func isOpaque(u: CGFloat, v: CGFloat) -> Bool {
    ...
    package func isOpaque(x: Int, y: Int) -> Bool {
