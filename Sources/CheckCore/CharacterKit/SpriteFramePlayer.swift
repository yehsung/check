...
package struct SpriteFramePlayer: Equatable, Sendable {
    ...
    package let totalDuration: TimeInterval

    package init(state: CharacterManifest.State) {
    ...
    package func frameIndex(elapsed: TimeInterval) -> Int {
