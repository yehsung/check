...
package enum CodexEffectiveRule {
    ...
    package static let overcountRatio = 1.2
    ...
    package static func localExceedsAccount(local: Int, account: Int?) -> Bool {
    ...
    /// - day > lastDay: 로컬.
    package static func day(_ day: String, local: Int, accountBucket: Int?, accountLastDay: String?) -> Int {
