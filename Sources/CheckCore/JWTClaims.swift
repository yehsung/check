...
package enum JWTClaims {
    /// `exp` 클레임(초 단위 epoch)을 Date 로 돌려준다. 못 읽으면 nil.
    package static func expiry(accessToken: String) -> Date? {
    ...
    package static func numericClaim(_ name: String, accessToken: String) -> Double? {
    ...
    package static func base64URLDecode(_ value: String) -> Data? {
