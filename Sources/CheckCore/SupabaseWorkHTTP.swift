...
extension SupabaseWorkService {
    package func sendNoBody<Body: Encodable>(
        path: String,
        method: String,
    ...
    package func send<Body: Encodable>(
        path: String,
        method: String,
        queryItems: [URLQueryItem] = [],
        body: Body?,
    ...
    package func serviceError(statusCode: Int, data: Data) -> SupabaseWorkServiceError {
    ...
    package func url(path: String, queryItems: [URLQueryItem]) throws -> URL {
