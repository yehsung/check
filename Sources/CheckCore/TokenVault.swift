...
package final class KeychainTokenVault: TokenVault {
    ...
    package func write(_ value: String, key: String) {
    ...
    package func delete(_ key: String) {
...
package final class InMemoryTokenVault: TokenVault {
...
package final class UserDefaultsTokenVault: TokenVault {
