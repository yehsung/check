...
/// 돌 색. 흑 선공.
nonisolated enum GomokuColor: String, Sendable, Codable, CaseIterable {
    case black, white
...
extension GomokuForbiddenReason {
    ...
    nonisolated init?(serverReason: String?) {
...
nonisolated enum GomokuJudgement: Equatable, Sendable {
...
nonisolated struct GomokuBoard: Equatable, Sendable {
    ...
    var stoneCount: Int { cells.reduce(0) { $0 + ($1 == 0 ? 0 : 1) } }
}
