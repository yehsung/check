...
extension SupabaseWorkService {
    ...
    func fetchEquippedCharacter(accessToken: String, userID: String) async throws -> String? {
...
struct CharacterSyncProfileRow: Decodable, Equatable {
    var character: String?
}

enum CharacterSyncFetchError: Error, Equatable {
