# Homebrew Cask 템플릿.
# scripts/release-brew.sh 가 version/sha256 자리표시자를 릴리즈 값으로 치환해
# tap 저장소(GH_OWNER/homebrew-check)의 Casks/check.rb 로 복사합니다.
# 직접 수정할 필요는 없습니다. 배포 흐름은 docs/release.md 참고.
cask "check" do
  version "__VERSION__"
  sha256 "__SHA256__"

  url "https://github.com/GH_OWNER/check/releases/download/v#{version}/check.zip"
  name "check"
  desc "Menu bar work-status and timer utility for small Mac teams"
  homepage "https://github.com/GH_OWNER/check"
